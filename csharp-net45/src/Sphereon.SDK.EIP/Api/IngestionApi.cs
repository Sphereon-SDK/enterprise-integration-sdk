...
namespace Sphereon.SDK.EIP.Api
{
    ...
    /// </summary>
    public interface IIngestionApi : IApiAccessor
    {
        ...
        /// <exception cref="Sphereon.SDK.EIP.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="documentId">documentId</param>
        /// <returns>Task of IngestionResponse</returns>
        System.Threading.Tasks.Task<IngestionResponse> GetDocumentStatusAsync (string documentId);
        ...
        /// <exception cref="Sphereon.SDK.EIP.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="documentId">documentId</param>
        /// <returns>Task of ApiResponse (IngestionResponse)</returns>
        System.Threading.Tasks.Task<ApiResponse<IngestionResponse>> GetDocumentStatusAsyncWithHttpInfo (string documentId);
        /// <summary>
        /// Push document to the ingestion queue
        /// </summary>
        /// <remarks>
        ...
        /// <param name="documentType">documentType (optional)</param>
        /// <returns>Task of IngestionResponse</returns>
        System.Threading.Tasks.Task<IngestionResponse> ReceiveDocumentAsync (string channelName, DocumentPayload documentPayload, string documentType = null);
        ...
        /// <param name="documentType">documentType (optional)</param>
        /// <returns>Task of ApiResponse (IngestionResponse)</returns>
        System.Threading.Tasks.Task<ApiResponse<IngestionResponse>> ReceiveDocumentAsyncWithHttpInfo (string channelName, DocumentPayload documentPayload, string documentType = null);
        /// <summary>
        /// Upload a file
        /// </summary>
        /// <remarks>
        ...
        /// <exception cref="Sphereon.SDK.EIP.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="stream">The document data to be ingested</param>
        /// <returns>Task of DocumentPayload</returns>
        System.Threading.Tasks.Task<DocumentPayload> UploadInputFileAsync (System.IO.Stream stream);
        ...
        /// <exception cref="Sphereon.SDK.EIP.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="stream">The document data to be ingested</param>
        /// <returns>Task of ApiResponse (DocumentPayload)</returns>
        System.Threading.Tasks.Task<ApiResponse<DocumentPayload>> UploadInputFileAsyncWithHttpInfo (System.IO.Stream stream);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class IngestionApi : IIngestionApi
    {
        ...
        /// <returns></returns>
        public IngestionApi(Configuration configuration = null)
        {
        ...
        public ApiResponse< IngestionResponse > GetDocumentStatusWithHttpInfo (string documentId)
        {
            ...
            if (documentId == null)
                throw new ApiException(400, "Missing required parameter 'documentId' when calling IngestionApi->GetDocumentStatus");
        ...
        /// <param name="documentId">documentId</param>
        /// <returns>Task of IngestionResponse</returns>
        public async System.Threading.Tasks.Task<IngestionResponse> GetDocumentStatusAsync (string documentId)
        {
             ApiResponse<IngestionResponse> localVarResponse = await GetDocumentStatusAsyncWithHttpInfo(documentId);
             return localVarResponse.Data;
        ...
        /// <param name="documentId">documentId</param>
        /// <returns>Task of ApiResponse (IngestionResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<IngestionResponse>> GetDocumentStatusAsyncWithHttpInfo (string documentId)
        {
            // verify the required parameter 'documentId' is set
            if (documentId == null)
                throw new ApiException(400, "Missing required parameter 'documentId' when calling IngestionApi->GetDocumentStatus");
        ...
        public ApiResponse< IngestionResponse > ReceiveDocumentWithHttpInfo (string channelName, DocumentPayload documentPayload, string documentType = null)
        {
            ...
            if (channelName == null)
                throw new ApiException(400, "Missing required parameter 'channelName' when calling IngestionApi->ReceiveDocument");
            // verify the required parameter 'documentPayload' is set
            if (documentPayload == null)
                throw new ApiException(400, "Missing required parameter 'documentPayload' when calling IngestionApi->ReceiveDocument");
        ...
        /// <param name="documentType">documentType (optional)</param>
        /// <returns>Task of IngestionResponse</returns>
        public async System.Threading.Tasks.Task<IngestionResponse> ReceiveDocumentAsync (string channelName, DocumentPayload documentPayload, string documentType = null)
        {
             ApiResponse<IngestionResponse> localVarResponse = await ReceiveDocumentAsyncWithHttpInfo(channelName, documentPayload, documentType);
             return localVarResponse.Data;
        ...
        /// <param name="documentType">documentType (optional)</param>
        /// <returns>Task of ApiResponse (IngestionResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<IngestionResponse>> ReceiveDocumentAsyncWithHttpInfo (string channelName, DocumentPayload documentPayload, string documentType = null)
        {
            // verify the required parameter 'channelName' is set
            if (channelName == null)
                throw new ApiException(400, "Missing required parameter 'channelName' when calling IngestionApi->ReceiveDocument");
        ...
        public ApiResponse< DocumentPayload > UploadInputFileWithHttpInfo (System.IO.Stream stream)
        {
            ...
            if (stream == null)
                throw new ApiException(400, "Missing required parameter 'stream' when calling IngestionApi->UploadInputFile");
        ...
        /// <param name="stream">The document data to be ingested</param>
        /// <returns>Task of DocumentPayload</returns>
        public async System.Threading.Tasks.Task<DocumentPayload> UploadInputFileAsync (System.IO.Stream stream)
        {
             ApiResponse<DocumentPayload> localVarResponse = await UploadInputFileAsyncWithHttpInfo(stream);
             return localVarResponse.Data;
        ...
        /// <param name="stream">The document data to be ingested</param>
        /// <returns>Task of ApiResponse (DocumentPayload)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<DocumentPayload>> UploadInputFileAsyncWithHttpInfo (System.IO.Stream stream)
        {
            // verify the required parameter 'stream' is set
            if (stream == null)
                throw new ApiException(400, "Missing required parameter 'stream' when calling IngestionApi->UploadInputFile");

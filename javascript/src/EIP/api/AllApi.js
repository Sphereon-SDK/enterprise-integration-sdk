...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.EnterpriseIntegrationApi.AllApi = factory(root.EnterpriseIntegrationApi.ApiClient, root.EnterpriseIntegrationApi.DocumentPayload, root.EnterpriseIntegrationApi.ErrorResponse, root.EnterpriseIntegrationApi.IngestionResponse);
  }
  ...
  /**
   * All service.
   * @module EIP/api/AllApi
   * @version 0.1
   */

  /**
   * Constructs a new AllApi. 
   * @alias module:EIP/api/AllApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:EIP/api/AllApi~getDocumentStatusCallback
     ...
     * @param {module:EIP/api/AllApi~getDocumentStatusCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:EIP/api/AllApi~receiveDocumentCallback
     * @param {String} error Error message, if any.
     * @param {module:EIP/model/IngestionResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:EIP/api/AllApi~receiveDocumentCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:EIP/model/IngestionResponse}
     */
     ...
     * @callback module:EIP/api/AllApi~uploadInputFileCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:EIP/api/AllApi~uploadInputFileCallback} callback The callback function, accepting three arguments: error, data, response

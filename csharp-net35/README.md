# Sphereon.SDK.EIP - the C# library for the Enterprise Integration API
...
```
nuget pack -Build -OutputDirectory out Sphereon.SDK.EIP.csproj
```
...
## Documentation for Models
 ...
 - [Model.DocumentPayload](docs/DocumentPayload.md)
 - [Model.Error](docs/Error.md)
 - [Model.ErrorResponse](docs/ErrorResponse.md)
 - [Model.IngestionResponse](docs/IngestionResponse.md)
